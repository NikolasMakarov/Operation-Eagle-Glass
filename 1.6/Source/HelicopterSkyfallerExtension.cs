...
namespace OperationEagleGlass
{
    public class HelicopterSkyfallerExtension : DefModExtension
    {
        ...
        public Vector2 gunDrawOffsetNorth = new Vector2(0f, -4f);
        public Vector2 gunDrawOffsetSouth = new Vector2(0f, -4f);
        public Vector2 gunDrawOffsetEast = new Vector2(0f, -4f);
        public Vector2 gunDrawOffsetWest = new Vector2(0f, -4f);
